package com.birthdaynote.ufilesdk.task;

import android.os.AsyncTask;
import android.text.TextUtils;
import android.util.Log;

import com.birthdaynote.ufilesdk.UFileRequest;
import com.birthdaynote.ufilesdk.UFileSDK;
import com.birthdaynote.ufilesdk.UFileUtils;
...
//        String canonicalUCloudHeaders = client.spliceCanonicalHeaders(request);
    ...
    protected String getAuthorization(UFileRequest uFileRequest) {
        String url = UFileRequest.authServer
