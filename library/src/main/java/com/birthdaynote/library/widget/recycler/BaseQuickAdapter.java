 ...
 */
package com.birthdaynote.library.widget.recycler;
...
import com.birthdaynote.library.widget.recycler.animation.AlphaInAnimation;
import com.birthdaynote.library.widget.recycler.animation.BaseAnimation;
import com.birthdaynote.library.widget.recycler.animation.ScaleInAnimation;
import com.birthdaynote.library.widget.recycler.animation.SlideInBottomAnimation;
import com.birthdaynote.library.widget.recycler.animation.SlideInLeftAnimation;
import com.birthdaynote.library.widget.recycler.animation.SlideInRightAnimation;
import com.birthdaynote.library.widget.recycler.diff.BaseQuickAdapterListUpdateCallback;
import com.birthdaynote.library.widget.recycler.diff.BaseQuickDiffCallback;
import com.birthdaynote.library.widget.recycler.entity.IExpandable;
import com.birthdaynote.library.widget.recycler.loadmore.LoadMoreView;
import com.birthdaynote.library.widget.recycler.loadmore.SimpleLoadMoreView;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private void autoLoadMore(int position) {
        ...
        if (!mLoading) {
            Log.e(TAG, "---------onLoadMoreRequested--------111---->"+mLoading);
